      ...
      body: SingleChildScrollView(
        child: FocusScope(
            ...
            onKeyEvent: (focusNode, event) {
              // if(!formArea.hasFocus || event.runtimeType != KeyDownEvent) return KeyEventResult.handled;
              if(!formArea.hasFocus || event is! KeyDownEvent) return KeyEventResult.ignored;
              if(event.logicalKey == LogicalKeyboardKey.arrowUp) {
                formArea.focusInDirection(TraversalDirection.up);
              }else if(event.logicalKey == LogicalKeyboardKey.arrowDown) {
                formArea.nextFocus();
              }else if(event.logicalKey == LogicalKeyboardKey.arrowLeft){
                formArea.focusInDirection(TraversalDirection.left);
              }else if(event.logicalKey == LogicalKeyboardKey.arrowRight){
                formArea.focusInDirection(TraversalDirection.right);
              }
                ...
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    child: FocusWcButton(
                      text: '屏幕翻转',
                      icon: MyIcons.screen,
                      onPressed: ()=> Global.rotatingScreen(conObj),
                    ),
                  ),
                ]
            )
